...
<body class="container">
    <form class="mt-5" action="{{route('student.store')}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Contact No" name="contact_no">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="exampleInputEmail1" placeholder="Enter Birth Date" name="dob">
        </div>
